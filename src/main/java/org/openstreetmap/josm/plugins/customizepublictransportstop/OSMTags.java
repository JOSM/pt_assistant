...
public final class OSMTags {
    ...
    public static final String STOP_AREA_GROUP_TAG_VALUE = "stop_area_group";
    ...
    public static final Collection<String> STOP_ROLES = Arrays.asList(STOP_ROLE, STOP_ENTRY_ROLE, STOP_EXIT_ROLE);
