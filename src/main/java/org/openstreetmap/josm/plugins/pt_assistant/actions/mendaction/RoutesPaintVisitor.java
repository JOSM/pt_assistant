...
public class RoutesPaintVisitor extends PaintVisitor {
    private final String I18N_ADD_ONEWAY_VEHICLE_NO_TWO_WAY;
    private final String I18N_CLOSE_OPTIONS = I18n.marktr("Close the options");
    private final String I18N_NOT_REMOVE_WAYS = I18n.marktr("Do not remove ways");
    private final String I18N_REMOVE_CURRENT_EDGE = I18n.marktr("Remove current edge (white)");
    private final String I18N_REMOVE_WAYS = I18n.marktr("Remove ways");
    private final String I18N_REMOVE_WAYS_WITH_PREVIOUS_WAY = I18n.marktr("Remove ways along with previous way");
    private final String I18N_SKIP = I18n.marktr("Skip");
    private final String I18N_SOLUTIONS_BASED_ON_OTHER_RELATIONS = I18n.marktr("solutions based on other route relations");
    private final String I18N_TURN_BY_TURN_NEXT_INTERSECTION = I18n.marktr("turn-by-turn at next intersection");
    private final String I18N_BACKTRACK_WHITE_EDGE = I18n.marktr("Split white edge");

    private final Color[] FIVE_COLOR_PALETTE = {
    ...
    private MendRelationInterface mendRelationObject;
     ...
     * @param mv
     */
    public RoutesPaintVisitor(Graphics2D g, MapView mv) {
        super(g, mv);
        this.g = g;
        this.mv = mv;
    ...
    protected class MendRelationAddMultipleLayer extends AbstractMapViewPaintable {
        ...
        public void paint(Graphics2D g, MapView mv, Bounds bbox) {
            RoutesPaintVisitor paintVisitor = new RoutesPaintVisitor(g, mv);
     ...
     *
     */
    protected static class MendRelationRemoveLayer extends AbstractMapViewPaintable {
        @Override
        public void paint(Graphics2D g, MapView mv, Bounds bbox) {
            RoutesPaintVisitor paintVisitor = new RoutesPaintVisitor(g, mv);
