 ...
 */
public class PersonalTransportMendRelation extends PublicTransportMendRelation {
    ...
    public PersonalTransportMendRelation(IRelationEditorActionAccess editorAccess) {
        ...
        super.editor.addWindowListener(new PersonalTransportMendRelation.WindowEventHandler());
    }
