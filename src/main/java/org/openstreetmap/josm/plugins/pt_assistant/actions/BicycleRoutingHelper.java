 ...
 * @author Biswesh
 */
public class BicycleRoutingHelper extends AbstractRelationEditorAction {
    ...
    public BicycleRoutingHelper(IRelationEditorActionAccess editorAccess) {
    ...
    //////enable state for the bicycle route ROUTING HELPER Done!!!!
    @Override
    ...
    void callNextWay(int i) {
        ...
        if (i < members.size() && members.get(i).isWay()) {
            ...
            Node node = checkValidityOfWays(way, j);          //-----------Have to check for bicycle separately
...
//////////have to change according to the Bicycle Route
...
//////////////have to change according to Bicycle routes without affecting Bus routes
    ...
    class MendRelationPaintVisitor extends PaintVisitor {
        ...
        void drawOptionsToRemoveWays() {
            ...
            if (numeric) {
                ...
                letterY = letterY + 60;
                if (notice.equals("vehicle travels against oneway restriction")) {
                    drawFixVariantLetter("4 : " + tr(I18N_ADD_ONEWAY_BICYCLE_NO_TO_WAY), FIVE_COLOR_PALETTE[3], letterX, letterY, 25);
                }
            } else {
                ...
                letterY = letterY + 60;
                if (notice.equals("vehicle travels against oneway restriction")) {
                    drawFixVariantLetter("C : " + tr(I18N_ADD_ONEWAY_BICYCLE_NO_TO_WAY), FIVE_COLOR_PALETTE[3], letterX, letterY, 25);
                    letterY = letterY + 60;
                }
